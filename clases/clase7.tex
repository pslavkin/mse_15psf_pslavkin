...
\begin{frame}[t]{Afinador de Guitarra}{Max y Local Max}
   ...
   \begin{columns}
      \begin{column}{.5\textwidth}
         ...
         \end{itemize}
      \lstinputlisting[firstline=84,lastline=102]{7_clase/ciaa/psf2/src/psf.c}
      \end{column}
      \begin{column}{.5\textwidth}
...
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{frame}[t]{Afinador de Guitarra}{Centroide}
   \videoicon{7}{00m00s}
   \footnotesize
   \lstset{ basicstyle=\fontsize{ 9}{ 2}\selectfont\ttfamily,language=c,tabsize=4}
   \begin{columns}
      \begin{column}{.5\textwidth}
         \begin{itemize}
            \item{Calculo el centroide de 21 puntos para aumentar la resolucion de 0.5 a 0.025}
         \end{itemize}
      \lstinputlisting[firstline=103,lastline=115]{7_clase/ciaa/psf2/src/psf.c}
      \end{column}
      \begin{column}{.5\textwidth}
