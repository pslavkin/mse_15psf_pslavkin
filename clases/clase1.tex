...
%-------------------------------------------------------------------------------
 \begin{frame}{Aliasing}{Simulando en Python}
    ...
    \pythonpic{1\_clase/teorema\_sampleo2}
...
%-------------------------------------------------------------------------------
 ...
 \begin{frame}{Ruido de cuantización}{Ejemplo de cuantización}
   \videoicon{1}{2h11m40s}
    Diferentes formas de onda cuantizadas
    \pythonpic{1\_clase/noise\_examples.py}
...
%-------------------------------------------------------------------------------
 \begin{frame}{Ruido de cuantización}{Cuantización en python}
    \videoicon{1}{2h15m40s}
    \handsonicon
    \lstset{ basicstyle=\fontsize{ 8}{ 2}\selectfont\ttfamily }
    \lstinputlisting[language=Python,tabsize=4]{1_clase/noise_examples.py}
    \vfill
 \end{frame}
%-------------------------------------------------------------------------------
 \begin{frame}{Ruido de cuantización}{Histogramas}
   \videoicon{1}{07m25s}
    ...
    \pythonpic{1\_clase/noise\_histogram}
