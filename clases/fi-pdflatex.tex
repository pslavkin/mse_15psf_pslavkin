...
\usepackage[
  main=spanish,activeacute, english]{babel}


%%
%% These macros specify information about the presentation
\title{Analisis de se\~nales} %% that will be typeset on the

\subtitle{Clase 1 - Introducci\'{o}n} %% title page.
\author{Pablo Slavkin}
...
%  \shorthandoff{-}
  ...
  \begin{tikzpicture}[overlay,remember picture]
       \node[anchor=south east,xshift=-30pt,yshift=45pt]
         at (current page.south east) {
           \includegraphics[width=45mm]{1_clase/noise_image}
         };
     \end{tikzpicture}%
  }
  ...
  \begin{darkframes}
    ...
    \begin{frame}{Señales y sistemas}
      ...
      \begin{itemize}
         \item{Tiempo continuo y señales de tiempo discreto}
         \item{Señales deterministas y no deterministas}
         \item{Señales pares e impares}
         \item{Señales periódicas y aperiódicas}
         \item{Energía y señales de energía}
         \item{Señales reales e imaginarias}
      \end{itemize}
    \end{frame}
