...
\usepackage[ main=spanish,activeacute, english]{babel}

%%
%% These macros specify information about the presentation
\title{Analisis de señnales} %% that will be typeset on the

\subtitle{Clase 1 - Introducción} %% title page.
...
%-------------------------------------------------------------------------------
   ...
   \begin{frame}{Sanmpleo}{Teorema del sampleo}
      \lstset{ basicstyle=\fontsize{ 8}{ 2}\selectfont\ttfamily }
      \lstinputlisting[language=Python,tabsize=4,lastline=30]{1_clase/teorema_sampleo.py}
      \vfill
   \end{frame}
