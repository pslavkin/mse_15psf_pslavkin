...
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}{$e^{j2\pi ft}$}{$e^{j2\pi ft}$ animado }
   \handsonicon
   \begin{columns}[onlytextwidth]
      \column{.6\textwidth}
...
\begin{frame}{$e^{j2\pi ft}$}{$e^{j2\pi ft}$ y $\sin(t)$ animados independientemente}
   ...
   \begin{columns}[onlytextwidth]
      ...
      \lstinputlisting[language=Python,tabsize=4]{3_clase/euler2.py}
      \column{.6\textwidth}
...
\begin{frame}{$e^{j2\pi ft}$}{$e^{j2\pi ft}$ modulado por $\sin(t)$ y centro de masas }
   ...
   \begin{columns}[onlytextwidth]
      \column{.4\textwidth}
      \lstset{ basicstyle=\fontsize{ 3}{ 0}\selectfont\ttfamily }
      \lstinputlisting[language=Python,tabsize=4]{3_clase/euler3.py}
      \column{.6\textwidth}
...
\begin{frame}{$e^{j2\pi ft}$}{$e^{j2\pi ft}$ modulado por $\sin(t)$ y centro de masas en f}
   ...
   \begin{columns}[onlytextwidth]
      ...
      \lstinputlisting[language=Python,tabsize=4]{3_clase/euler4.py}
      \column{.6\textwidth}
...
\begin{frame}{$e^{j2\pi ft}$}{$e^{j2\pi ft}$ del centro de masas de vuelta a $\sin(t)$}
   ...
   \begin{columns}[onlytextwidth]
      ...
      \column{.2\textwidth}
      \lstinputlisting[language=Python,tabsize=4,lastline=45]{3_clase/euler5.py}
      \column{.2\textwidth}
      \lstinputlisting[language=Python,tabsize=4,firstline=46]{3_clase/euler5.py}
      \column{.6\textwidth}
...
\begin{frame}{$e^{j2\pi ft}$}{Señales complejas, conejo}
   ...
   \begin{columns}[onlytextwidth]
      \lstset{ basicstyle=\fontsize{ 2}{ 1}\selectfont\ttfamily }
      \column{.2\textwidth}
      \lstinputlisting[language=Python,tabsize=4,lastline=50]{3_clase/euler6.py}
      \column{.2\textwidth}
      \lstinputlisting[language=Python,tabsize=4,firstline=51]{3_clase/euler6.py}
      \column{.6\textwidth}
